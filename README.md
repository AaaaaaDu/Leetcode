...
|983| 最低票价|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/mincostTickets.js)|
|979| 在二叉树中分配硬币|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/distributeCoins.js)|
...
|950| 按递增顺序显示卡牌|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/deckRevealedIncreasing.js)|
...
|697| 数组的度    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findShortestSubArray.js)|
|696| 计数二进制子串    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/countBinarySubstrings.js)|
|695| 岛屿的最大面积    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/maxAreaOfIsland.js)|
|693| 交替位二进制数    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/hasAlternatingBits.js)|
|687| 最长同值路径    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/longestUnivaluePath.js)|
|686| 重复叠加字符串匹配    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/repeatedStringMatch.js)|
|682| 棒球比赛    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/calPoints.js)|
|680| 验证回文字符串 Ⅱ    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/validPalindrome.js)|
|677| 键值映射    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/MapSum.js)|
|676| 实现一个魔法字典     |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/MagicDictionary.js)|
|674| 最长连续递增序列     |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findLengthOfLCIS.js)|
|671| 二叉树中第二小的节点     |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findSecondMinimumValue.js)|
|669| 修剪二叉搜索树     |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/trimBST.js)|
|667| 优美的排列 II      |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/constructArray.js)|
|665| 非递减数列      |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/checkPossibility.js)|
|661| 图片平滑器      |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/imageSmoother.js)|
|657| 判断路线成圈      |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/judgeCircle.js)|
...
|540| 有序数组中的单一元素   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/singleNonDuplicate.js)|
|538| 把二叉搜索树转换为累加树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/convertBST.js)|
|537| 复数乘法   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/complexNumberMultiply.js)|
|535| TinyURL 的加密与解密   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/TinyURL.js)|
|532| 数组中的K-diff数对   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findPairs.js)|
|530| 二叉搜索树的最小绝对差|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/getMinimumDifference.js)|
...
|479| 最大回文数乘积|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/largestPalindrome.js)|
|476| 数字的补数|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findComplement.js)|
|475| 供暖器|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findComplementfindRadius.js)|
|463| 岛屿的周长|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/islandPerimeter.js)|
...
|452| 用最少数量的箭引爆气球|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findMinArrowShots.js)|
...
|445| 两数相加 II|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/addTwoNumbersList.js)|
|443| 压缩字符串|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/compress.js)|
...
|427| 建立四叉树|[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/construct.js)|
...
|393| UTF-8 编码验证 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/validUtf8.js)|
|392| 判断子序列 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/isSubsequence.js)|
...
|260| 只出现一次的数字 III |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/singleNumberIII.js)|
|258| 各位相加 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/addDigits.js)|
|257| 二叉树的所有路径 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/binaryTreePaths.js)|
...
|235| 二叉搜索树的最近公共祖先  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/LCA.js)|
|234| 回文链表  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/isPalindromeList.js)|
...
|203| 删除链表中的节点 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/removeElements.js)|
|202| 快乐数 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/isHappy.js)|
|200| 岛屿的个数 |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/numIslands.js)|
|198| 打家劫舍  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/rob.js)|
|191| 位1的个数  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/hammingWeight.js)|
|190| 颠倒二进制位  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/reverseBits.js)|
|189| 旋转数组  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/rotateArray.js)|
|187| 重复的DNA序列  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/findRepeatedDnaSequences.js)|
|173| 二叉搜索树迭代器  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/BSTIterator.js)|
|172| 阶乘后的零  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/trailingZeroes.js)|
|171| Excel表列序号  |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/titleToNumber.js)|
...
|116| 填充同一层的兄弟节点   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/connect.js)|
|114| 二叉树展开为链表   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/flatten.js)|
|112| 路径总和   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/hasPathSum.js)|
|111| 二叉树的最小深度   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/minDepth.js)|
|110| 平衡二叉树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/isBalanced.js)|
|109| 有序链表转换二叉搜索树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/sortedListToBST.js)|
|108| 将有序数组转换为二叉搜索树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/sortedArrayToBST.js)|
|107| 二叉树的层次遍历 II   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/levelOrderBottom.js)|
|106| 从中序与后序遍历序列构造二叉树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/buildTree.js)|
|105| 从前序与中序遍历序列构造二叉树   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/buildTreeFromPreAndIn.js)|
|104| 二叉树的最大深度   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/maxdepth.js)|
|103| 二叉树的锯齿形层次遍历   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/zigzagLevelOrder.js)|
|102| 二叉树的层次遍历    |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/levelOrder.js)|
...
|50| Pow(x, n)   |[javascript](https://github.com/DcySc/Leetcode/blob/master/algorithms/myPow.js)|
